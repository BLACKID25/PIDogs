...
//   useEffect(() => {
//     let image = document.getElementById("dogimage");
//     setImageDim({ w: image ? image.naturalWidth : 0, h: image.naturalHeight });
//   }, [dog]);
...
//         src={bckDog}
//         alt="RefDog"
//         className={`${imageDim.w > imageDim.h ? style.wideDog : style.stretchDog}`}
//       />
//       <div
//         className={`${
//           imageDim.w > imageDim.h ? style.wideContainer : style.stretchContainer
...
//         <Link to="/home" className={style.backButton}></Link>
//         {dog.created ? (
//           <a onClick={() => handleDelete(dog.id)} className={style.deleteDog}></a>
//         ) : (
//           <a
//             className={style.googleSearch}
//             href={`https://www.google.com/search?client=firefox-b-d&q=${
